import { ActionList, Banner,Toast, BlockStack, Box,ContextualSaveBar ,  Button,Frame, ButtonGroup, Card, Checkbox, Collapsible, DatePicker, Form, FormLayout, Grid, Icon, InlineGrid, InlineStack, Layout, LegacyCard, LegacyStack, Link, OptionList, Page, Popover, Scrollable, Select, Tabs, Text, TextContainer, TextField, Tooltip, useBreakpoints } from '@shopify/polaris';
...
export const loader = async({request})=>{
    ...
    const response = await admin.graphql(`query {
      ...
      console.log(result,"result---tttttt");
      ...
      const appName = metafielData.filter(item => item.node.namespace === "Cart Favicon");
      const appSettings = appName.length > 0 ? appName[0].node.value : {
        app_name: "Cart Favicon",
        app_status: false,
        shape: "Circle",
...
function Favicon_cart_count(props) {
    ...
    const SettingsDataTab = () => {
      ...
      const handleSelectChange = useCallback((value, property) => {
    ...
    //   }, []);
                              ...
                              <div className='checkbox_section'>
                                            <BlockStack gap="400">
                                                <Select
                                                    ...
                                                    onChange={(value) => handleSelectChange(value, 'shape')}
                                                ...
                                                <Select
                                                    ...
                                                    onChange={(value) => handleSelectChange(value, 'animation')}
        ...
        connectedLeft={
          <input
            type='color'
            onChange={(e) =>
                handleColorChange(e, "badge_color")
              }
      ...
      />
                                                ...
                                                <Select
                                                    ...
                                                    onChange={(value) => handleSelectChange(value, 'animation_repeat')}
                                    ...
                                    <BlockStack gap="200">
                                        ...
                                        <BlockStack gap="200">
                                            <Text as="p" fontWeight="reguler">
                                                If you need help with setting up the Favicon Cart Count app, please check our exhaustive Help Center for details.
                                            </Text>
