...
export const loader = async ({ request }) => {
    ...
    const defaultSettings = {
        ...
        cookie_consent_text: "We use cookies to improve your experience and track website usage.",
        ...
        // only_show_europe: "0",
        informative_banner_text: "We use cookies to improve your experience and track website usage.",
...
function CookieBanner(props) {
                ...
                <Card sectioned>
                    <BlockStack gap='400'>
                        <div className='arrow-sign'>
                            <BlockStack gap={200}>
                                <div onClick={() => handleToggle('generalDesignSettings')} style={{ display: "inline-block", cursor: "pointer" }}>
                                ...
                                <Text variant="bodySm" as="p">
                                    Personalize the appearance and overall settings, such as visual elements and general preferences.
                                </Text>
                            </BlockStack>
                        </div>
                        <Collapsible
            ...
            <div >
                <Card sectioned>
                    <BlockStack gap='500'>
                        <div className='arrow-sign'>
                            <BlockStack gap={200}>
                                <div onClick={() => handleToggle("cookiesettings")} style={{ display: "inline-block", cursor: "pointer" }}>
                                    <div style={{ float: "left" }}>
                                        <Text variant="headingSm" as="h6">
                                            <InlineStack gap={300}> Cookie Consent Banner 
                                ...
                                <Text variant="bodySm" as="p">
                                    To comply with GDPR and other data protection laws, if you have customized your customer privacy settings in Shopify, a cookie consent banner is necessary to obtain visitor consent for tracking purposes.
                                    {/* <Link href="#">
                        ...
                        >
                            ...
                            <BlockStack gap='400'>
                                <div className='cookies_banner_secondary_Color_card'>
                                    <Card>
                                        <BlockStack gap={500}>
                                            ...
                                            <Text variant="bodyMd" as="p">
                                                The Cookie Consent banner is displayed only to customers from the selected regions, according to Shopify's API server response.
                                            </Text>
                                ...
                                />
                                {(formData.reject_btn_style ==="Outline") && <div className='color_section'>
                                    <TextField
                                ...
                                <div>
                                    ...
                                    <Text variant="bodyMd" as="p">
                                        Give your visitors control over their cookie consent settings by adding a link that triggers the cookie banner. For instructions on how to do this, <Link>follow this guide</Link>.
                                    </Text>
                                </div>
            ...
            <div >
                <Card sectioned>
                    <BlockStack gap='500'>
                        <div className='arrow-sign'>
                            <BlockStack gap={200}>
                                <div onClick={() => handleToggle('informativeCookieBanner')} style={{ display: "inline-block", cursor: "pointer" }}>
                                    <div style={{ float: "left" }}>
                                        <Text variant="headingSm" as="h6">
                                            <InlineStack gap={300}>Informative Cookie Banner  
                                            {(formData.informative_banner_status === "Active")?<Badge 
                                            tone="success">Active</Badge>:<Badge>Inactive</Badge>}</InlineStack>
                                        </Text>
                                    </div>
                                    <div style={{ float: "right" }}>
                                        <InlineStack>
                                ...
                                <Text variant="bodySm" as="p">
                                    If your visitors are not required to give permission before their data can be used, you can display an informative banner. It will notify the visitors that by using your service, they accept your Privacy Policy.
                                    <Link href="#">
                                        <Text variant="headingSm" as="h5">Preview</Text>
                                    </Link>
                                </Text>
                ...
                <BlockStack gap={500}>
                    <div className='upper_section'>
                        <Grid>
                            ...
                            <Grid.Cell columnSpan={{ xs: 6, sm: 3, md: 3, lg: 6, xl: 6 }}>
                                <div className="all_in_one_preview_layout" style={{position:"sticky",top:"-5%"}}>
                                    <div className="grid_2nd_card_conatiner">
                                        <div className="grid_2nd_inner_card_conatiner">
                                            ...
                                            <div className="product_preview_quantity">
                                                <input className="product_input" type="number" value="1" />
                                            </div>
                                            ...
                                            {(openStates.cookiesettings)?
                                            (<div className={(formData.cookie_banner_theme ==="Floating")?'cookie-bottom':'cookie-bottom fixed-cookie'} style={{backgroundColor:formData.cookie_banner_bg}}>
                                                <p style={{color:formData.cookie_banner_color}}>
                                                    {formData.cookie_consent_text} {(formData.learnmore_pivacylink)?<a href={formData.learnmore_pivacylink} style={{color:formData.learnmore_color}}>{formData.learnmore_text}
                                                    </a>:""}
                                                </p>
                                                <button className='cookie-btn' 
                                                 style={{backgroundColor:formData.acceptbtn_bg , color:formData.acceptbtn_color }}
                                                >{formData.cookie_consent_accept_text}</button>
                                                    {formData.cookie_consent_reject_text && (
                                                        <>
                                                            ...
                                                            {formData.reject_btn_style === "Text only" && (
                                                                <button className='cookie-btn-reject text-onlybtn-reject'
                                                                    style={{
                                                                        color: formData.reject_text_color,
                                                                        borderColor: "transparent"
                                                                    }}>
                                            ...
                                            <div className={(formData.cookie_banner_theme ==="Floating")?'cookie-bottom':'cookie-bottom fixed-cookie'} style={{backgroundColor:formData.cookie_banner_bg}}>
                                                <p style={{color:formData.cookie_banner_color}}>
                                                    {formData.informative_banner_text} {(formData.learnmore_pivacylink)?<a href={formData.learnmore_pivacylink} style={{color:formData.learnmore_color}}>{formData.learnmore_text}
                                                    </a>:""}
                                                </p>
                                                <button className='cookie-btn' 
                                                style={{backgroundColor:formData.acceptbtn_bg , color:formData.acceptbtn_color }}
                                                >{formData.informative_accept_text}</button>
                                            </div>)}
    ...
    const AnalyticsPaymentsTab = () => {
        return (
            <div style={{ padding: "10px" }} className='Cookies_Banner_page_AnalyticsPaymentsTab_container'>
                <BlockStack gap='600'>
                    <div><DateRangePicker /></div>
                    <Card>
                        <BlockStack gap={800}>
                            <GraphCard />
                            <div className='analytic_card_icon_only' style={{ textAlign: 'center' }}>
                                <BlockStack gap={100}>
                                    <Icon source={BookOpenIcon}> </Icon>

                                    <Text as='h6' variant='headingMd'>Your analytics will be displayed here</Text>
                                    <Text as='p' variant='bodyXs'>No data available yet.</Text>
                                </BlockStack>
                            </div>
                        </BlockStack>
                    </Card>
